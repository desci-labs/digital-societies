  ...
  return (
    <div className="container mx-auto flex items-center justify-start p-4">
      ...
      <div className="flex gap-5 items-center">
        <TransactionHint />
        {!hide && (
          <NavLink href="/launch" activeClassName="border-white text-white" className="text-sm border border-regent-gray hover:border-white hover:bg-white hover:text-black p-1 duration-200">
