...
export type GetSocietiesQuery = { __typename?: 'Query', societies: Array<{ __typename?: 'Society', admin?: any | null, delegateRoleId?: string | null, id: any, metadataUri: string, verified?: boolean | null, attestations: Array<{ __typename?: 'Attestation', metadataUri: string, id: string }> }> };

export type AllAttestationsQueryVariables = Exact<{ [key: string]: never; }>;


export type AllAttestationsQuery = { __typename?: 'Query', attestations: Array<{ __typename?: 'Attestation', id: string, metadataUri: string, recipients: Array<{ __typename?: 'Token', id: string, tokenId?: any | null, active?: boolean | null, issuedBy?: any | null, issuedAt?: any | null, owner: { __typename?: 'User', id: any }, attestation: { __typename?: 'Attestation', id: string }, society: { __typename?: 'Society', id: any } }> }> };

export type GetDesocAttestationsQueryVariables = Exact<{
  society: Scalars['String'];
}>;
...
export const useGetSocietiesQuery = <
    ...
    useQuery<GetSocietiesQuery, TError, TData>(
      ...
      fetcher<GetSocietiesQuery, GetSocietiesQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetSocietiesDocument, variables),
      options
    );
export const AllAttestationsDocument = `
  ...
  attestations {
    ...
    `;
export const useAllAttestationsQuery = <
      TData = AllAttestationsQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables?: AllAttestationsQueryVariables,
      options?: UseQueryOptions<AllAttestationsQuery, TError, TData>
    ) =>
    useQuery<AllAttestationsQuery, TError, TData>(
      variables === undefined ? ['AllAttestations'] : ['AllAttestations', variables],
      fetcher<AllAttestationsQuery, AllAttestationsQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, AllAttestationsDocument, variables),
      options
    );
export const GetDesocAttestationsDocument = `
  ...
  attestations(where: {society: $society}) {
    ...
    `;
export const useGetDesocAttestationsQuery = <
      TData = GetDesocAttestationsQuery,
      TError = unknown
    >(
      dataSource: { endpoint: string, fetchParams?: RequestInit },
      variables: GetDesocAttestationsQueryVariables,
      options?: UseQueryOptions<GetDesocAttestationsQuery, TError, TData>
    ) =>
    useQuery<GetDesocAttestationsQuery, TError, TData>(
      ['getDesocAttestations', variables],
