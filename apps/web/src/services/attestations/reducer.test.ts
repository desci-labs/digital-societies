...
const mockAttestation: Attestation = {
  ...
  metadataUri:
    "https://w3s.link/ipfs/bafkreibiaufpjgatkxajg56xjy6kwsglq2vdmxryjsppbb2qmoafusrxny",
  createdAt: 1666533876000,
  society: "0x780E037a5B1d87E99cbBA0d0D3961fC61510Ecbd",
};
  ...
  describe("Tokens update", () => {
    ...
    it("Update existing tokens of an attestation", () => {
      ...
      const tokenToUpdate: RevokedAttestationToken = {
        society: "0x36C6a9b59dE798c354799f1E1E9646D8008A4FB6",
        tokenId: 1,
        owner: "0x855D6DB82BC9941731ef4c8f24EF8F8c2Ba70d57",
        active: false,
        issuedBy: "0x855D6DB82BC9941731ef4c8f24EF8F8c2Ba70d57",
        attestation: "1",
        revokedBy: "0xe861856C961F853DC47e5F2aD1fa2b9eA20e4E88",
        issuedAt: 1667146668000,
        revokedAt: 1667146668000,
      };
